...
/*   |-------------------------------------------------|    |-------------------------------------------------|   */\
       OS_LSFT , OS_LCTL , OS_LALT , OS_LGUI , MS_BTN1 ,      KC_LEFT , KC_DOWN , KC_UP   , KC_RGHT , KC_ENT  ,     \
/*   |-------------------------------------------------|    |-------------------------------------------------|   */\
       CT_CIRC , CT_TREM , CT_AIG  , CT_GRV  , KC_NO   ,      MS_LEFT , MS_DOWN , MS_UP   , MS_RGHT , KC_DEL  ,     \
/*   `-------------------------------------------------|    |-------------------------------------------------'   */\
                                     CT_AGUI , CT_CGUI ,      KC_LSFT , TO_HOME
/*                                 `-------------------'    `-------------------'                                 */
